...
describe("createInjectorModuleMatcher", () => {
    it("recognizes the real @nonna/di package resolved through a pnpm workspace symlink", () => {
        // di/compiler depends on @nonna/di via workspace:*, which pnpm
        ...
        const matcher = createInjectorModuleMatcher(__dirname, "@nonna/di");
        const realEntry = require.resolve("@nonna/di");
